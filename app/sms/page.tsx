...
import { createSMSCampaign, getSMSCampaigns } from "@/app/actions/sms"
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          ...
          <Card className="p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold">{campaigns.reduce((sum, c) => sum + (c.delivered_count || 0), 0)}</p>
            ...
            <Card key={campaign.id} className="p-4">
              <div className="flex justify-between items-start mb-3">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground mb-2">{campaign.message_template}</p>
                </div>
              ...
              <div className="grid grid-cols-4 gap-4 text-sm">
                ...
                <div>
                  ...
                  <span className="ml-2 font-medium">{new Date(campaign.created_at).toLocaleDateString("pt-BR")}</span>
                </div>
              </div>
