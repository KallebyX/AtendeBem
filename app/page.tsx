...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-background">
      {/* Header */}
      <header className="border-b border-border sticky top-0 bg-background/95 backdrop-blur-md z-50 transition-all duration-200">
      ...
      <section className="container mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16 lg:py-32">
        <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
          <div className="space-y-6 sm:space-y-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-7xl font-bold text-foreground leading-tight text-balance animate-in fade-in slide-in-from-bottom-4 duration-700 delay-100">
            ...
            <div className="flex flex-wrap items-center gap-4 sm:gap-6 pt-2 sm:pt-4 text-xs sm:text-sm text-muted-foreground animate-in fade-in slide-in-from-bottom-4 duration-700 delay-400">
              ...
              <div className="flex items-center gap-1.5 sm:gap-2">
                <Database className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-primary flex-shrink-0" />
          ...
          <div className="relative animate-in fade-in slide-in-from-right-8 duration-1000 delay-200">
            <div className="absolute -inset-4 bg-gradient-to-r from-primary/10 to-secondary/10 rounded-3xl blur-2xl opacity-50"></div>
            <Image
              src="/images/hero.jpeg"
              alt="AtendeBem Interface"
              width={600}
              height={400}
      ...
      {/* Features Section */}
      <section id="recursos" className="bg-muted py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold mb-3 sm:mb-4 text-balance">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 lg:gap-8">
            {[
              ...
              <Card
                key={index}
                className="rounded-3xl border-border hover:border-primary/30 hover:shadow-xl transition-all duration-300 hover:-translate-y-1 group"
                style={{
                  animationDelay: `${index * 100}ms`,
                }}
              >
                <CardContent className="p-6 sm:p-8 space-y-4">
                  <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-secondary flex items-center justify-center group-hover:scale-110 transition-transform duration-300">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              ...
              <Card
                key={index}
                className="rounded-3xl border-border hover:border-destructive/30 hover:shadow-lg transition-all duration-300 hover:-translate-y-1"
              >
                <CardContent className="p-5 sm:p-6 space-y-3 sm:space-y-4">
                  <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-2xl bg-destructive/10 flex items-center justify-center">
      ...
      <section id="como-funciona" className="bg-muted py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl lg:text-5xl font-semibold mb-3 sm:mb-4 text-balance">Como Funciona</h2>
            <p className="text-base sm:text-lg lg:text-xl text-muted-foreground text-balance max-w-2xl mx-auto">
              ...
              <div key={index} className="relative">
                <Card className="rounded-3xl border-2 border-primary/20 h-full hover:border-primary/40 hover:shadow-xl transition-all duration-300 group">
                  <CardContent className="p-6 sm:p-8 space-y-4 sm:space-y-6">
                    <div className="text-6xl sm:text-7xl font-bold text-primary/20 group-hover:text-primary/30 transition-colors">
                      {step.number}
                    </div>
                ...
                {index < 2 && (
                  <ArrowRight className="hidden lg:block absolute top-1/2 -right-6 w-6 h-6 text-primary/30 -translate-y-1/2" />
                )}
              </div>
            ))}
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 sm:gap-8 lg:gap-10 max-w-6xl mx-auto">
            {[
              {
                metric: "70%",
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-16 items-center">
            <div className="space-y-6 sm:space-y-8 order-2 lg:order-1">
              ...
              <p className="text-base sm:text-lg text-muted-foreground leading-relaxed text-pretty">
                Sistema completo de receita digital com assinatura ICP-Brasil e0-CPF/e-CNPJ, QR Code de validação
              ...
              <div className="grid sm:grid-cols-2 gap-4">
                {[
                  ...
                  <Card key={index} className="rounded-3xl border-border hover:shadow-lg transition-all duration-300">
            ...
            <div className="relative order-1 lg:order-2">
              <div className="absolute -inset-4 bg-gradient-to-br from-primary/10 to-secondary/10 rounded-3xl blur-2xl opacity-50"></div>
                ...
                <CardContent className="p-6 sm:p-8 space-y-6 bg-gradient-to-br from-background to-secondary/5">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center justify-between pt-2">
                      ...
                      <div className="w-16 h-16 bg-foreground/5 rounded-xl flex items-center justify-center">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <Card className="rounded-3xl bg-primary text-primary-foreground border-0 shadow-2xl overflow-hidden">
            <CardContent className="p-8 sm:p-12 lg:p-16 text-center space-y-6 sm:space-y-8">
              <Sparkles className="w-12 h-12 sm:w-16 sm:h-16 mx-auto animate-pulse" strokeWidth={1.5} />
              <div className="space-y-3 sm:space-y-4">
