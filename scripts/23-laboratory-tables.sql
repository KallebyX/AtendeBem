CREATE TABLE IF NOT EXISTS lab_orders (
  ...
  integration_type VARCHAR(50), -- 'manual', 'api', 'email', 'hl7'
...
CREATE TABLE IF NOT EXISTS lab_exams (
  ...
  exam_code VARCHAR(20), -- TUSS code
  exam_name VARCHAR(255) NOT NULL,
  exam_type VARCHAR(100), -- 'sangue', 'urina', 'imagem', etc
...
CREATE TABLE IF NOT EXISTS lab_templates (
  ...
  description TEXT,
  category VARCHAR(100), -- 'rotina', 'checkup', 'pré-operatório', etc
  
  exams JSONB NOT NULL, -- [{code: '40301010', name: 'Hemograma completo'}, ...]
...
-- Templates padrão
INSERT INTO lab_templates (name, description, category, exams, is_public) VALUES
('Hemograma Completo', 'Exame de sangue básico', 'rotina', 
 '[{"code": "40301010", "name": "Hemograma completo", "type": "sangue"}]'::jsonb, true),
('Checkup Anual', 'Exames de rotina anuais', 'checkup',
 '[{"code": "40301010", "name": "Hemograma completo", "type": "sangue"},
   ...
   {"code": "40302180", "name": "Creatinina", "type": "sangue"}]'::jsonb, true),
('Pré-Operatório', 'Exames para cirurgia', 'pré-operatório',
 '[{"code": "40301010", "name": "Hemograma completo", "type": "sangue"},
   {"code": "40302350", "name": "Coagulograma", "type": "sangue"},
   {"code": "40301150", "name": "Glicemia de jejum", "type": "sangue"}]'::jsonb, true);
